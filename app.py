...
@app.route('/') #This is the homepage default route which we see in our localhost
def home():
    return render_template('home.html')

@app.route('/predict_api',methods=['POST']) #Posting our data in JSON fromat which is stored in data key
def predict_api():
